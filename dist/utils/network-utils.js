 ...
 */
export const findAvailablePort = async (knownUsedPort, startPort = 50000, stopPort = 50999) => {
    ...
    throw new Error(`No available port found in range ${startPort} to ${stopPort}, excluding: ${knownUsedPort.join(', ')}`);
};
