 ...
 */
export function validateSafeString(value, fieldName) {
    ...
    if (dangerousChars.test(value)) {
        throw new Error(`${fieldName} contains unsafe characters. Only alphanumeric, dots, hyphens, and underscores are allowed.`);
    }
 ...
 */
export function validateSafeDomainName(domainName) {
 ...
 */
export function validateSafePath(filePath, baseDir, fieldName) {
 ...
 */
export function validateSshCredentials(remoteHost) {
 ...
 */
export function generateSecureTempFilename(prefix, extension) {
 ...
 */
export function validateCertPath(certDir, domainName) {
