 ...
 */
export const PROXY_SET_HEADERS = [
    ['Host', '$host'],
 ...
 */
export const DEFAULT_ADD_HEADERS = [
 ...
 */
export function validateHeaderKey(key) {
    ...
    if (blocked) {
        throw new Error(`Header "${key}" is managed by the proxy configuration and cannot be set`);
    }
}
/**
