...
export const changeRepo = async ({ name, newRepo, newBranch, }) => {
    ...
    Logger.advice(`The repository ${newRepo ? 'URL ' : ''}${newRepo && newBranch ? 'and ' : ''}${newBranch ? 'branch ' : ''}${newRepo || newBranch ? 'has' : 'have'} been updated. ` +
