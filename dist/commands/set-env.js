...
export const setEnvForApp = async ({ name, envName, envValue, }) => {
    ...
    Logger.success(`To apply the changes, run: ${Logger.highlight(`dm deploy ${name}`)}`);
};
/**
 ...
 */
export const launchEnvEditorForApp = async (name) => {
