        ...
        commands: [
            {
                ...
                usage: 'init <name> --repo <url> [--branch b] [--port n] [--instances n] [--type nextjs|nestjs|dotnet] [--project-dir d] [--vcs git|svn]',
            },
            {
                name: 'deploy',
...
export const TOP_LEVEL_COMMANDS = COMMAND_GROUPS.flatMap((g) => g.commands.map((c) => c.name));
