        ...
        children: [
          /* @__PURE__ */ jsxs(
            Box,
            {
              ...
              width: DETAIL_W,
              children: [
                /* @__PURE__ */ jsx(Text, { dimColor: true, children: "pm2 log \u2014 0 lines" }),
                /* @__PURE__ */ jsx(Text, { dimColor: true, children: "X clear" })
              ]
            }
          ),
          /* @__PURE__ */ jsx(Box, { marginTop: 1, children: /* @__PURE__ */ jsx(Text, { dimColor: true, children: "No log output captured yet. Logs stream in as the app produces them." }) })
        ]
      }
    );
  }
    ...
    Box,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs(Box, { flexDirection: "row", justifyContent: "space-between", width: DETAIL_W, children: [
          ...
          /* @__PURE__ */ jsx(Text, { dimColor: true, children: "X clear PgUp/PgDn" })
        ] }),
        parsed.map((e, i) => {
          ...
          if (e.severity === "error")
            return /* @__PURE__ */ jsxs(Box, { flexDirection: "row", gap: 1, children: [
              ...
              /* @__PURE__ */ jsx(Text, { color: "red", children: e.message })
            ] }, i);
          if (e.severity === "warn")
            return /* @__PURE__ */ jsxs(Box, { flexDirection: "row", gap: 1, children: [
              ts !== "" && /* @__PURE__ */ jsx(Text, { dimColor: true, children: ts }),
              /* @__PURE__ */ jsx(Text, { color: "yellow", children: "!" }),
              /* @__PURE__ */ jsx(Text, { children: e.message })
            ] }, i);
          return /* @__PURE__ */ jsxs(Box, { flexDirection: "row", gap: 1, children: [
            /* @__PURE__ */ jsxs(Text, { dimColor: true, children: [
              ts,
            ...
            /* @__PURE__ */ jsx(Text, { dimColor: true, children: e.message })
          ] }, i);
        })
      ]
    }
